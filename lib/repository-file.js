...
module.exports = class RepositoryFile {
  ...
  async load() {
    ...
    const [providerOverride, remoteOverride, branchOverride] = await Promise.all([
      this.repo.getConfigValueAsync("lumine.open-repository.provider"),
      this.repo.getConfigValueAsync("lumine.open-repository.remote"),
      this.repo.getConfigValueAsync("lumine.open-repository.branch"),
    ]);
    this.configCache["lumine.open-repository.provider"] = providerOverride;
    this.configCache["lumine.open-repository.remote"] = remoteOverride;
    this.configCache["lumine.open-repository.branch"] = branchOverride;
